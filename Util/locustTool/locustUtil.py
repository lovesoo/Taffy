...
class locustUtil(object):
    def __init__(self, locustyml='config/locust.yml'):
        ...
        self.cases = yaml.load(io.open(locustyml_path, 'r', encoding='utf-8'))
    ...
    def genLocustfile(self, name='locustfile.py'):
        ...
        tasks = list(dict((i["class"] + i["function"], i) for i in tasks).values())
        ...
        for task in tasks:
            ...
            with io.open(os.path.join(os.path.dirname(__file__), 'template/import_template'), encoding='utf-8') as import_template:
            ...
            with io.open(os.path.join(os.path.dirname(__file__), 'template/function_template'), encoding='utf-8') as function_template:
            ...
            with io.open(os.path.join(os.path.dirname(__file__), 'template/task_template'), encoding='utf-8') as task_template:
        ...
        with io.open(os.path.join(os.path.dirname(__file__), 'template/locustfile_template'), encoding='utf-8') as locustfile_template:
            with io.open(name, mode='w', encoding='utf-8') as f:
